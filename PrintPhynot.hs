...
instance Print AbsPhynot.Stm where
  prt i = \case
    ...
    AbsPhynot.WriteInt -> prPrec i 0 (concatD [doc (showString "writeInt"), doc (showString "("), doc (showString ")")])
    AbsPhynot.WriteFloat -> prPrec i 0 (concatD [doc (showString "writeFloat"), doc (showString "("), doc (showString ")")])
    AbsPhynot.WriteChar -> prPrec i 0 (concatD [doc (showString "writeChar"), doc (showString "("), doc (showString ")")])
    AbsPhynot.WriteString -> prPrec i 0 (concatD [doc (showString "writeString"), doc (showString "("), doc (showString ")")])
