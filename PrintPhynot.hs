...
instance Print AbsPhynot.RExp where
  prt i = \case
    ...
    AbsPhynot.Mul rexp1 rexp2 -> prPrec i 4 (concatD [prt 4 rexp1, doc (showString "*"), prt 5 rexp2])
    AbsPhynot.Div rexp1 rexp2 -> prPrec i 4 (concatD [prt 4 rexp1, doc (showString "/"), prt 5 rexp2])
    AbsPhynot.Mod rexp1 rexp2 -> prPrec i 4 (concatD [prt 4 rexp1, doc (showString "%"), prt 5 rexp2])
    AbsPhynot.Pow rexp1 rexp2 -> prPrec i 5 (concatD [prt 5 rexp1, doc (showString "^"), prt 6 rexp2])
    AbsPhynot.PointerRef rexp -> prPrec i 6 (concatD [doc (showString "&"), prt 7 rexp])
    AbsPhynot.DereferenceVal rexp -> prPrec i 6 (concatD [doc (showString "*"), prt 7 rexp])
    AbsPhynot.Neg rexp -> prPrec i 6 (concatD [doc (showString "-"), prt 7 rexp])
    AbsPhynot.IntValue n -> prPrec i 7 (concatD [prt 0 n])
    AbsPhynot.FloatValue d -> prPrec i 7 (concatD [prt 0 d])
    AbsPhynot.StringValue str -> prPrec i 7 (concatD [printString str])
    AbsPhynot.CharValue c -> prPrec i 7 (concatD [prt 0 c])
    AbsPhynot.BooleanValue boolean -> prPrec i 7 (concatD [prt 0 boolean])
    AbsPhynot.VarValue id_ -> prPrec i 7 (concatD [prt 0 id_])
    AbsPhynot.ArrayIndexValue id_ dims -> prPrec i 7 (concatD [prt 0 id_, prt 0 dims])
    AbsPhynot.FuncCall id_ rexps -> prPrec i 7 (concatD [prt 0 id_, doc (showString "("), prt 0 rexps, doc (showString ")")])
    AbsPhynot.FuncCallNoParam id_ -> prPrec i 7 (concatD [prt 0 id_, doc (showString "()")])
